			...
			<form id="form">
				<ul id="ui_container" v-show='formShow'>
					...
					<li class="line_li">
						...
						<div class="li_content_div_right">
							<span>胎盘干细胞</span>
							<input class='two_input_one_line' v-model="cellStorageProject" id='cs2' value='胎盘干细胞' type="checkbox" required>
							<span> 脐带干细胞</span>
							<input class='two_input_one_line' v-model="cellStorageProject" id='cs3' value=' 脐带干细胞' type="checkbox" required>
						</div>
					...
					<li class="line_li">
						...
						<div class="li_content_div_right">
							<span>免疫细胞</span>&nbsp;&nbsp;&nbsp;
							<input class='two_input_one_line' v-model="cellStorageProject" id='cs1' value='免疫细胞' type="checkbox" required>
							<span>牙髓干细胞</span>
							<input class='two_input_one_line' v-model="cellStorageProject" id='cs4' value='牙髓干细胞' type="checkbox" required>
					...
					<li class="line_li">
						...
						<div class="li_content_div_right">
							<span>脂肪干细胞</span>
							<input class='two_input_one_line' v-model="cellStorageProject" id='cs5' value='脂肪干细胞' type="checkbox" required>
							<span>子宫内膜干细胞</span>
							<input class='two_input_one_line' v-model="cellStorageProject" id='cs6' value='子宫内膜干细胞' type="checkbox" required>
				...
				<a href="javascript:void(0);" class="common-btn" v-show='submitShow' v-on:click="closeAppointment">{{close}}</a>
			</form>
		</div>
	</div>
	</div>
	...
	export default {
		...
		methods: {
			...
			submitForm(event) {
				...
				if(this.cellStorageProject.length == 0 || !this.personalIndustry || !this.totalNumber || !this.minor || !this.visitDate || this.intention.length == 0 || this.relationShip.length == 0) {
					this.msg = '请将信息填写完整!'
//					alert("请将信息填写完整!")
				} else {
					...
					var url = domainUtils.domain + "/addCellStorageAppointment"
			...
			toBuy: function() {
				this.$router.push({
					...
					params: {
						...
						retComponent: '1' //0 artCenter 1 cellCenter
					}
				});
			}
		},
